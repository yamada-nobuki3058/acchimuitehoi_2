def janken
  ...
  while your_hand_select != 0 && your_hand_select != 1 && your_hand_select != 2 do
...
def attimuitehoi_1
  ...
  while your_direction_select != 0 && your_direction_select != 1 && your_direction_select != 2 && your_direction_select != 3 do
    puts "無効な入力です。もう一度選んでください。"
    puts "上:0、左:1、右:2、下:3"
    your_direction_select = gets.to_i
  end
